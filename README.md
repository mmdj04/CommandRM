...
CommandRM is free and open-source. You can test it online at <https://marmelab.com/commandrm-demo>.
...
- ✉️ **Capture Emails**: CC CommandRM to automatically save communications as notes.
...
Fork the [`marmelab/commandrm`](https://github.com/marmelab/commandrm) repository to your user/organization, then clone it locally:
...
The user and developer documentation for this project is available [in the `doc/` directory](./doc/). You can also read it online at [https://marmelab.com/commandrm/doc/](https://marmelab.com/commandrm/doc/).
...
CommandRM components are published as a Shadcn Registry file. This means you can update your installation by calling the following command:
...
- The `http://marmelab.com/commandrm/r/commandrm.json` file is automatically published by the CI/CD pipeline
