---
name: frontend-dev
description: Coding practices for frontend development in CommandRM. Use when creating or modifying React components, forms, list pages, detail views, filters, data fetching, or responsive layouts.
---
