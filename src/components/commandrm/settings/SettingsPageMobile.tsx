    ...
    <div>
      ...
      <p className="text-sm text-muted-foreground mb-2 px-1">
        {translate("crm.profile.inbound.description", {
          _: "Você pode começar a enviar emails para o endereço de email de entrada do seu servidor, por exemplo, adicionando-o ao campo Cc:. O CommandRM processará os emails e adicionará anotações aos contatos correspondentes.",
          field: "Cc:",
        })}
      </p>
      <ItemGroup className="rounded-lg border overflow-hidden">
