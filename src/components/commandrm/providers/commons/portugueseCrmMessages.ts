export const portugueseCrmMessages = {
  ...
  ra: {
    ...
    message: {
      ...
      batch_confirm_title: "%{name} |||| %{name} %{smart_count} itens",
      bulk_update_title: "%{name} |||| %{name} %{smart_count} itens",
      bulk_update_content: "Tem certeza que deseja atualizar %{name}? |||| Tem certeza que deseja atualizar %{name} %{smart_count} itens?",
      access_denied: "Acesso negado",
      are_you_sure: "Tem certeza?",
      undo: "Desfazer",
      authenticate_error: "Credenciais inválidas",
    },
    navigation: {
      no_results: "Nenhum resultado encontrado",
      no_more_results: "Nenhum resultado na página %{page}. Tente a página anterior.",
    ...
    search: "Pesquisar",
    show: "Exibir",
    clear_input: "Limpar campo",
    post_create_edit: "Editar",
  },
  crm: {
    action: {
    ...
    auth: {
      ...
      welcome_title: "Bem-vindo ao CommandRM",
    },
    common: {
      activity: "Atividade",
      added: "adicionou",
    ...
    profile: {
      inbound: {
        description:
          "Você pode começar a enviar emails para o endereço de email de entrada do seu servidor, por exemplo, adicionando-o ao campo %{field}. O CommandRM processará os emails e adicionará notas aos contatos correspondentes.",
