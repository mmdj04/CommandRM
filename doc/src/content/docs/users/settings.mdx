...
description: This document explains how to configure CommandRM.
---

Admin users can configure various aspects of CommandRM to tailor the application to their specific needs. This includes customizing the user interface, defining categories, etc. 
