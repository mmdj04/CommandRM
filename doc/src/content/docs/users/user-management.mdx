...
description: This document explains how to manage users in CommandRM.
---

## Creating the First User

The first time you open the CommandRM App, you will be prompted to create the first user. This first user will automatically be granted administrator role.
