---
title: REST API
description: This document explains how to use the CommandRM API outside of the Supabase data provider.
---

CommandRM exposes a complete REST API that lets you do everything you can do with the CRM.
...
Use the Supabase Studio to see the [automatically generated documentation](https://supabase.com/dashboard/project/_/api) for your CommandRM instance. It lists all the available endpoints and their parameters. This page explains how to call each endpoint either with the supabase client, or bash (curl).
