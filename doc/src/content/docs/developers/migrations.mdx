---
title: Migrations
description: This document explains how to create and manage database migrations in CommandRM.
---

CommandRM uses [declarative database schemas](https://supabase.com/docs/guides/local-development/declarative-database-schemas) to manage its database structure. The schema is defined in `.sql` files under `supabase/schemas/`, and migrations are auto-generated from those files.
...
If you change the data structure for a contact, don't forget to modify the sample CSV file located at [`src/components/commandrm/contacts/contacts_export.csv`](https://github.com/marmelab/commandrm/blob/main/src/components/commandrm/contacts/contacts_export.csv). You'll also need to modify the import function found in [`src/components/commandrm/contacts/useContactImport.tsx`](https://github.com/marmelab/commandrm/blob/main/src/components/commandrm/contacts/useContactImport.tsx).
